...
# ✅ Função corrigida: compatível com qualquer link do Google Sheets
@st.cache_data
...
# 📄 URL da planilha principal conectada
...
# 👤 Filtra apenas o funcionário Vinicius
...
fig2 = px.bar(
    df_receita, x='DataLabel', y='Valor', text='Valor',
